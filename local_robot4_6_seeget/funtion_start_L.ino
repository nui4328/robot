//------------->>  ปล่อยหุ่นยนต์หันหน้าไปทางขวาของคนปล่อย
...
void stL_can1_to_MD()
  {
    ...
    do{Motor(20,20);}while(mcp_b(7) < md_mcp_b(7));delay(10);
          
    do{Motor(40,-40);}while(mcp_f(3) > md_mcp_f(3));delay(20);          
    Motor(-50,40); delay(30); 
    do{Motor(-15,20);}while(mcp_f(2) > md_mcp_f(2));
    fw_2sensor(30, 30, 0.3, 0, "2:3","b0", 20);  
    do{Motor(30,30);delay(5);}while(mcp_b(0) < md_mcp_b(0));delay(60);       
    fline(0,0,0.5,10,'n','l',30, "a4", 15);
    slow_servo_down();
