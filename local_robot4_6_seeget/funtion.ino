...
void tx_left(int sp, int ofset)
{
  ...
  do {Motor(-sp, sp);} while (mcp_f(0) < md_mcp_f(0)); delay(10);
  do {Motor(-sp, sp);} while (mcp_f(0) > md_mcp_f(0)); 
  do {Motor(-sp, sp);} while (mcp_f(0) > md_mcp_f(0));
  do {Motor(-sp, sp);} while (mcp_f(2) > md_mcp_f(2));
  do {Motor(-sp, sp);} while (mcp_f(3) > md_mcp_f(3)); delay(10);
...
{
  Motor(0, 0); delay(50);
  do {Motor(sp, -sp);} while (mcp_f(7) > md_mcp_f(7) ); 
  do {Motor(sp, -sp);} while (mcp_f(7) < md_mcp_f(7)); delay(10);
  do {Motor(sp, -sp);} while (mcp_f(7) > md_mcp_f(7)); 
  do {Motor(sp, -sp);} while (mcp_f(7) > md_mcp_f(7));
  do {Motor(sp, -sp);} while (mcp_f(5) > md_mcp_f(5));
  do {Motor(sp, -sp);} while (mcp_f(4) > md_mcp_f(4)); delay(10);
...
void circle()
{
  fline_2sensor(30, 30, 0.7, 0, "3:4", "a0", 'p', 0);delay(20);
  Motor(-30, -30); delay(30);
  Motor(0, 0); delay(100);
  do {Motor(40, -20);} while (mcp_f(3) > md_mcp_f(3));
  Motor(-40, 20); delay(30);

  fline_2sensor(27, 27, 0.8, 0, "3:4", "a7", 'p', 0);
  do {Motor(-20, 40);} while (mcp_f(4) > md_mcp_f(4));

  fline_2sensor(27, 27, 0.7, 0, "3:4", "a7", 'p', 10);
  fline(20, 20, 0.1, 100, 'n', 'r', 40, "a4", 10);

  fline_2sensor(27, 27, 0.8, 0, "3:4", "a7", 'p', 0);
  do {Motor(-20, 40);} while (mcp_f(4) > md_mcp_f(4));
  fline_2sensor(20, 20, 0.5, 0, "3:4", "a7", 'p', 20);
  fline_2sensor(20, 20, 1, 100, "1:2", "a7", 's', 20);
  fline(0, 0, 0.5, 10, 'n', 'r', 40, "a4", 20);
