...
void box_7()
  {
     down_servo();
     fline(40,40,0.3,0,'c','p',45, "a5", 25);  
     fline(30,30,0.5,0,'f','s',45, "a5", 1);        
     fline_2sensor(20,20,0.2,0,"3:4","27",'p',0);
     fline_2sensor(20,20,0.2,0,"3:4","a0",'p',20);
     do{Motor(40,-15);}while(mcp_f(4) > md_mcp_f(4));
     Motor(-40, 15); delay(20);
     Motor(0, 0); delay(100);

     fline_2sensor(20,20,0.7,0,"3:4","a7",'p',20);
     ...
     fw_a3_a4(40, 40, 0.3, 0); 
     fw_stop_center();     
     fline(40,40,0.45,0,'c','s',45, "a5", 1);
...
void box_9()
  {
     ...
     do {Motor(40, -15);} while (mcp_f(3) > md_mcp_f(3));
     Motor(-40, 10); delay(20);
  
     fline_2sensor(20, 20, 0.5, 0, "3:4", "a7", 'p', 0);
...
void box_14()
  {
    ...
    bw_a3_a4(40, 40, 0.3, 0);
    bw_stop_ba0(); 
    fline(0,0,0.3,10,'n','l',40, "a2", 2); 
    fline(0,0,0.3,10,'n','l',40, "a2", 2); 
    fline(0,0,0.3,10,'n','l',40, "a3", 30);
