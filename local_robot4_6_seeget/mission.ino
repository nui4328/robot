void mission_L()  //วางกล่องซ้าย
  {
    ...
    do{Motor(50,-15);}while(mcp_f(0) > md_mcp_f(0));delay(10);
    do{Motor(50,-15);}while(mcp_f(0) < md_mcp_f(0)); delay(10);
    Motor(-50,20); delay(10);
    do{Motor(-30,50);}while(mcp_f(0) > md_mcp_f(0));delay(10);
    do{Motor(-30,50);}while(mcp_f(1) > md_mcp_f(2));delay(10);
    do{Motor(-30,50);}while(mcp_f(1) < md_mcp_f(2));delay(10);
    Motor(30,-50); delay(20);    

    
    fline(40,40,0.5,250,'n','s',50, "a4", 1);
    fw_a3_a4(40, 30, 0.3, 2);delay(70);
    ...
    if(tll == 0)
      ...
      do{Motor(-20,50);}while(mcp_f(4) > md_mcp_f(4));delay(10); 
      Motor(20,-50); delay(20); 
      if(mcp_f(2)> md_mcp_f(2))
        {
          do{Motor(-5,20);}while(mcp_f(2) > md_mcp_f(2));
        }
...
void mission_R() //วางกล่องขวา
  {
    ...
    do{Motor(-15,50);;}while(mcp_f(7) > md_mcp_f(7));delay(10);
    do{Motor(-15,50);;}while(mcp_f(7) < md_mcp_f(7)); delay(10);
    Motor(15,-50); delay(10);
    do{Motor(50,-30);;}while(mcp_f(7) > md_mcp_f(7));delay(10);
    do{Motor(50,-30);;}while(mcp_f(6) > md_mcp_f(5));delay(10);
    do{Motor(50,-30);}while(mcp_f(6) < md_mcp_f(5));delay(10);
    Motor(-50,30); delay(20);    

    
    fline(40,40,0.5,250,'n','s',50, "a3", 1);
    ...
    if(trr == 0)
      ...
      do{Motor(50,-20);}while(mcp_f(2) > md_mcp_f(2));delay(10); 
      //do{Motor(70,-20);}while(mcp_f(0) < md_mcp_f(0)); 
      Motor(-50,20); delay(20); 
      if(mcp_f(6)> md_mcp_f(6))
        {
          do{Motor(-5,20);}while(mcp_f(6) > md_mcp_f(6));
        }
...
void mission_MD() //วางกล่องกลาง
  {
    fline(30,30,0.3,0,'c','l',30, "b3", 20);
    do{Motor(30,30);}while(mcp_b(7) > md_mcp_b(7));
    //do{Motor(30,30);}while(mcp_b(7) < md_mcp_b(7));
    Motor(-30, -30); delay(20);
    Motor(0, 0); delay(100);
    
    do{Motor(50,-20);}while(mcp_f(3) > md_mcp_f(3));delay(20);
    //do{Motor(70,-20);}while(mcp_f(0) < md_mcp_f(0));  
    Motor(-50,20); delay(20); 
    ...
    do{Motor(30,-30);}while(mcp_f(3) > md_mcp_f(3));delay(20);          
    ...
    do{Motor(25,25);}while(mcp_b(0) < md_mcp_b(0));delay(50);       
    fline(0,0,0.5,10,'n','l',30, "a3", 15);
    slow_servo_down();
    ...
    if(tmd == 0)
      ...
      bline(20,20,0.3, 0, 'c', 'r',40, "b1", 10);
      ...
      do{Motor(50,-20);}while(mcp_f(0) > md_mcp_f(0));delay(10);
      //do{Motor(50,-20);}while(mcp_f(0) < md_mcp_f(0));delay(20);
      Motor(-50,20); delay(20); 
      fw_2sensor(30,30,0.4,0,"5:6","b7",10);
     ...
     do{Motor(25,25);}while(mcp_b(7) < md_mcp_b(7));delay(20);
      ...
      do{Motor(50,-20);}while(mcp_f(2) > md_mcp_f(2));delay(20); 
      //do{Motor(70,-20);}while(mcp_f(0) < md_mcp_f(0)); 
      Motor(-50,20); delay(20); 
      if(mcp_f(6)> md_mcp_f(6))
        {
